...
API_TOKEN = "8619212784:AAGNRWitsKF5EScwGnTvhUMAzatrGjj2Glo"
...
def start(message):
    ...
    bot.send_message(message.chat.id, f"স্বাগতম {message.from_user.first_name}! আমি সচল আছি।", reply_markup=markup)
...
if __name__ == '__main__':
    # ওয়েব প্যানেল চালু করা
    t = threading.Thread(target=run_web)
    t.daemon = True
    t.start()
    
    print("✅ Bot and Admin Panel are starting...")
